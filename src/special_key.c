...
/*   Updated: 2014/01/15 16:59:59 by abrault          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int			special_key(t_env *e, int keycode)
{
	...
	id = e->data->map[(int)(e->data->pos_y / SIZE_CASE +
			sin(ft_rad(e->data->rot)))][(int)(e->data->pos_x / SIZE_CASE +
			cos(ft_rad(e->data->rot)))];
